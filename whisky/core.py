...
def extract_from_array(array, hdr, kpi, save_im=False, wfs=False, plotim=False, manual=0,  
    wrad=25.0, sg_ld=1.0, D=0.0,re_center=True, window=True,  bsp=False, adjust_sampling=True):
