...
rmax   = 5.093           # outer diameter:      5.093 m
rmin   = 1.1*1.829           # central obstruction: 1.829 m
thick  = 4*0.257            # adopted spider thickness (meters)
...
np.savetxt("./geometry/palomarnew.txt", np.transpose((xs,ys)), 
           fmt='%12.9f')
